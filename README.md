...
CRON_SECRET=...
PUBLIC_CALCOM_USERNAME=tu-usuario-calcom
PUBLIC_BOOKING_URL=https://cal.com/tu-usuario-calcom
VERCEL_TOKEN=...
VERCEL_ORG_ID=...
VERCEL_PROJECT_ID=...
```
...
**¿Preguntas?** [Agenda una llamada](https://cal.com/tu-usuario-calcom) o [escríbeme](mailto:aiyautomation@zohomail.com)